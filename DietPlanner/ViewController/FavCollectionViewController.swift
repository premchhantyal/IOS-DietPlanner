...
class FavCollectionViewController: UICollectionViewController {
    ...
    var favCollection = DatabaseService.shared.fetchAllRecipeDetails();
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        return self.favCollection.count
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        var c = self.favCollection.count
        cell.recipe = self.favCollection[indexPath.item]
