...
class RecipeTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        ServiceController.shared.getRecipes(mealType: self.mealType, cuisine:self.selectedCuisine, intolerances: self.intolerances) { resultFromAPI in
